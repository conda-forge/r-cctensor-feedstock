...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-cctensor-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14359&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-cctensor-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-cctensor` can be installed with:

```
conda install r-cctensor
```

It is possible to list all of the versions of `r-cctensor` available on your platform with:
